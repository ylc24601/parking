...
// create-next-app default landing at root `/`. Not one of the three product
// surfaces (member/staff/admin); Slice 3.5 only strips the `dark:*` variants so it
// stays light under the app's single light theme. A proper landing is backlog.
