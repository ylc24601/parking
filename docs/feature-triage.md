...
**強烈建議交付前**：#5A ✅、**#15 ✅（2A-1／2A-2 完成，剩 2A-3 retention）**、**#14A ✅（2B-1）→ 容量已不需 SQL**、**#10 ✅（2B-2a＋2B-2b）→ 資格已不需 CSV**（幹事可自行核准/撤銷，且 CSV 不再能推翻人工決定；2B-2c 佇列列內操作為便利化、不阻擋交付）、#12 ✅
